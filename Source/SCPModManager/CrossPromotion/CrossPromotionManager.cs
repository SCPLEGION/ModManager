...
// SCPModManager/SCPModManager/CrossPromotionManager.cs
...
public static class CrossPromotionManager
{
    ...
    internal static string CachePath
    {
        get
        {
            ...
            {
                path = SCPModManager.Settings.UseTempFolderForCrossPromotions
    ...
    public static void HandleCrossPromotions(ref Rect canvas, ModMetaData mod)
    {
        ...
        if (!SCPModManager.Settings.ShowPromotions || !Manifest.For(mod).showCrossPromotions)
        {
            return;
        }
        ...
        {
            Utilities.OpenSettingsFor(SCPModManager.Instance);
        }
