...
{
    private readonly CallResult<RemoteStorageDownloadUGCResult_t> _callResult;
    ...
    public bool ShouldShow => Ready && (SCPModManager.Settings.ShowPromotions_NotSubscribed && !Installed ||
                                        SCPModManager.Settings.ShowPromotions_NotActive && !Active);
