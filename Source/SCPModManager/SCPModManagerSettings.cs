...
public class SCPModManagerSettings : ModSettings
{
    public bool AddExpansionsToNewModLists = true;
    public bool AddHugsLibToNewModLists;
    public bool AddSCPModManagerToNewModLists = true;
    ...
    public override void ExposeData()
    {
        ...
        Scribe_Values.Look(ref AddSCPModManagerToNewModLists, "AddSCPModManagerToNewModLists", true);
    ...
    public void DoWindowContents(Rect canvas)
    {
        ...
        GUI.color = Color.white;
        listing.Gap();
        listing.CheckboxLabeled(I18n.AddSCPModManagerToNewModList, ref AddSCPModManagerToNewModLists,
            I18n.AddSCPModManagerToNewModListTip);
        ...
        listing.Gap();
        listing.CheckboxLabeled("SCPLegion.SCPModManager.SkipPublishingCountdown".Translate(), ref SkipPublishingCountdown);

        var colorRect = listing.GetRect(30f);
        Widgets.Label(colorRect.LeftHalf(), "SCPLegion.SCPModManager.BackgroundColor".Translate());
        ...
        listing.GapLine();
        if (listing.ButtonTextLabeledPct("SCPLegion.SCPModManager.ResetLabel".Translate(),
                "SCPLegion.SCPModManager.Reset".Translate(), 0.75f))
        {
            Reset();
        }

        if (SCPModManager.CurrentVersion != null)
        {
            listing.Gap();
            GUI.contentColor = Color.gray;
            listing.Label("SCPLegion.SCPModManager.ModVersion".Translate(SCPModManager.CurrentVersion));
    ...
    private void Reset()
    {
        ...
        AddSCPModManagerToNewModLists = true;
