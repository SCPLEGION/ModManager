...
public static class ModButtonManager
{
    ...
    private static ModButton_Installed SCPModManagerMod => AllButtons.First(b => b.IsSCPModManager) as ModButton_Installed;
    ...
    public static void Sort()
    {
        ...
        foreach (var activeButton in ActiveButtons)
        {
            ...
            if (activeButton is not ModButton_Installed installedActiveButton)
            {
                continue;
            }
        ...
        foreach (var activeButton in ActiveButtons)
        {
            ...
            Messages.Message(I18n.SortFailed_Cyclic(activeButton.Name, success.Reason),
    ...
    public static void Reset(bool addDefaultMods = true)
    {
        ...
        if (addDefaultMods)
        {
            ...
            if (SCPModManager.Settings.AddExpansionsToNewModLists)
            {
            ...
            if (SCPModManager.Settings.AddHugsLibToNewModLists)
            {
            ...
            if (SCPModManager.Settings.AddSCPModManagerToNewModLists && SCPModManagerMod != null)
            {
                SCPModManagerMod.Active = true;
            }

            if (SCPModManager.Settings.AddHugsLibToNewModLists || SCPModManager.Settings.AddSCPModManagerToNewModLists)
            {
